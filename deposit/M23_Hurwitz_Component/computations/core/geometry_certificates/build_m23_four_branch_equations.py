...
json_path=OUT/'M23_four_branch_equations.json'
json_path.write_text(json.dumps(payload,indent=2),encoding='utf-8')
text_path=OUT/'M23_four_branch_equations.txt'
with text_path.open('w',encoding='utf-8') as f:
 f.write('M23 FOUR-BRANCH COEFFICIENT MODEL\n'+'='*72+'\n\n')
...
summary=OUT/'M23_four_branch_equations_summary.json'
